CC = g++
CCFLAGS = -Wall
SOURCES = main.cpp Controller/Game.cpp Model/Item.cpp Model/Player.cpp Utility/ResourceManager.cpp Utility/Timer.cpp Utility/Tools.cpp View/SDLmodule.cpp
